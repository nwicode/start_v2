...
export class SubheaderService implements OnDestroy {
  ...
  constructor(private layout: LayoutService, private title: Title, private meta: Meta, private translate: TranslationService,) {
  ...
  setBreadcrumbs(breadcrumbs: BreadcrumbItemModel[] = []) {
    ...
    if (breadcrumbs[0]) this.title.setTitle(this.translate.translatePhrase(breadcrumbs[0].title)+" - " + window.location.hostname);
  }
