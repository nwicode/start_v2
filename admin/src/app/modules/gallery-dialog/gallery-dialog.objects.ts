...
export class GalleryDialog {
    ...
    constructor(imageSrc: string = '', selectMultiple: boolean = false, fileTypes = '.png,.jpg', uploadDirectory = 'files') {
...
export class GalleryImage {
    ...
    constructor(title: string = '', imageUrl: string = '', isFile: boolean, isParent: boolean) {
        this.title = title;
